...
export class PaymentMethodEntity {
  ...
  @ApiProperty({ description: '마스킹된 카드번호', example: '**** **** **** 1234', nullable: true })
  masked_card_number?: string | null;

  @ApiProperty({ description: '카드 소유자 이름', example: '홍길동', nullable: true })
  ...
  @ApiProperty({ description: '만료일 (표시용)', example: '12/2028', nullable: true })
  expiry_display?: string | null;

  @ApiProperty({ description: '카드 만료 여부', example: false })
  is_expired?: boolean;

  @ApiProperty({ description: '청구지 주소', example: '서울시 강남구', nullable: true })
  billing_address?: string | null;

  @ApiProperty({ description: '청구지 우편번호', example: '06234', nullable: true })
  billing_zip?: string | null;

  @ApiProperty({ description: '사용자 지정 별칭', example: '주카드', nullable: true })
  alias?: string | null;
