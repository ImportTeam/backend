import { PopbillCardLimitResponse, PopbillCardRegistrationStartRequest, PopbillCardRegistrationStartResponse, PopbillClient } from './popbill.client';
...
export class PopbillClientStub implements PopbillClient {
  ...
  async getCardLimit(_userUuid: string, paymentMethodSeq: bigint): Promise<PopbillCardLimitResponse> {
