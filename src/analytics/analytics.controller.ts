...
export class AnalyticsController {
  ...
  /**
   * curl 예시(로컬)
   * curl -X GET "http://localhost:3000/api/analytics/categories" -H "Authorization: Bearer <JWT>"
   */
  @Get('categories')
  @ApiOperation({
  ...
  /**
   * curl 예시(로컬)
   * curl -X GET "http://localhost:3000/api/analytics/months" -H "Authorization: Bearer <JWT>"
   */
  @Get('months')
  @ApiOperation({
